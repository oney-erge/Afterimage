...
2.04 GB/s (the archived lossless-engine design note Phase A), a 10x shortfall against the
...
def decode_gpu_v2(enc: ChunkedEncoded, block_chunks: int = 32, device: str = "cuda") -> torch.Tensor:
    ...
    13.83 GB/s on the same data -- see the archived lossless-engine design note Phase A),
