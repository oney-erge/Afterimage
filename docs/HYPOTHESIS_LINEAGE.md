...
**H9 numbering.** [BOUNDED_RESEARCH_REPORT_2026-08-21.md](BOUNDED_RESEARCH_REPORT_2026-08-21.md)
closes by proposing *"H9 — layout-aware residency"*. That proposal was
subsequently implemented as **H14/H15**, and the H9 slot was taken by the RAM
overlay. Read that section as a forward-looking note under its own numbering,
not as a description of the shipped H9.
